...
namespace Tests
{
    ...
    public class FightMoveTreeTest
    {
        ...
        public async Task case0() // get one list with 3 position 
        {
            ...
            bool listCountOk = c.GetGeneratedLists().Count == 1;
            bool elementsCountOnListOk = c.GetGeneratedLists().First().Count == 3;
        ...
        public void case2()
        {
            ...
            bool listCountOk = c.GetGeneratedLists().Count == 3;
            var longestWay = c.GetGeneratedLists().Where(x => x.Count == 3).ToList();
        ...
        public void case5King()
        {
            ...
            FightMoveTree tree = new FightMoveTree(board, ownerPawn);
            TreeConverter<FightMoveNode> c = new TreeConverter<FightMoveNode>(tree.Nodes);
            bool listCountOk = c.GetGeneratedLists().Count == 4;
